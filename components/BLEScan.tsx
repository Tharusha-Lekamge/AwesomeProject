...
export default function BLEScan({back}: WifiScreenProps) {
  ...
  return (
    <ScrollView>
      ...
      <View style={styles.wrapper} id='HotspotHelper'>
        ...
        <View style={{width: '100%'}}>
          <Pressable
            ...
            onPress={async () => {
              try {
                ...
                ToastAndroid.show(
                  `Write settings permission is ${
                    state ? 'granted' : 'not graned'
                  }`,
                  ToastAndroid.SHORT,
                );
              } catch (error) {
          ...
          <Pressable
            ...
            <Text style={{color: '#000'}}>
              Navigate to write settings screen
            </Text>
          </Pressable>
          <Pressable
            style={styles.button}
      ...
      <View style={{marginVertical: 15}}>
        {devices.map((d, i) => (
          <View style={styles.devicesWrapper} key={i}>
